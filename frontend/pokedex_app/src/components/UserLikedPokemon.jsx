...
const UserLikedPokemon = ({likedPokemon}) => {
	...
	return (
		<section className="justify-center items-center grid columns-3">
		<ul className="grid grid-cols-8 mx-5 text-center list-inside font-bold opacity-80 rounded-lg border-double text-3xl font-mono border-pink-950 border-4 bg-slate-800">
			{

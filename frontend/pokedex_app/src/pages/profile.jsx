...
const Profile = () => {
	...
	<div>
        <main className="h-screen bg-cover bg-center" style={{backgroundImage: `url(${background})`}}>
            ...
            <h1 className="font-bold w-full max-w-md mx-auto rounded-lg opacity-80 border-8 bg-sky-700 text-center text-5xl font-pokemon py-10 text-pink-950 border-pink-950">{testData.username}</h1>
